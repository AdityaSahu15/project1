...
function Navbar() {
  ...
  return (
    <div className='navbar sticky top-0 z-50 bg-gradient-to-r from-blue-600 to-purple-600 text-white py-4 px-4 sm:px-6 md:px-10 shadow-md text-lg flex flex-wrap justify-between items-center backdrop-blur-sm'>
      ...
      <div className="flex flex-wrap items-center gap-3 sm:gap-4 md:gap-8 flex-1 justify-end">
        ...
        <form>
          <input
            ...
            className='px-3 py-1 rounded-full text-black w-28 sm:w-40 md:w-52 focus:outline-none focus:ring-2 focus:ring-purple-300 shadow-inner'
          />
        </form>
